...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
	...
	<body>
		...
		<form action="/member/loginMember" method="post">
		    ...
		    <label for="m_email"> Email: <input type="text" id="m_email" name="mEmail"></label><br>
		    <label for="m_pw"> Password : <input type="password" id="m_pw" name="mPw"></label><br>
		...
		<p><strong>회원가입 후 관리자의 승인완료 시 접속가능 하도록 구현</strong></p>
