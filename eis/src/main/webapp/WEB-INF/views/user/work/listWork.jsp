...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="/css/workList.css">
	<style type="text/css">
	...
	<script type="text/javascript">
		...
		function searchBtn() {
			...
			var $form = $('#searchForm');
			$form.attr('action', '/work/listWork');
			$form.submit();
		}
	
		function businessRegist() {
		/* 글쓰기 버튼 눌렀을 때  */
			location.href = '/work/registWork';
		}
		...
		/* 글 상세페이지로 이동 */
			...
			var $form = $('#detailForm');
			$form.attr('action', '/work/detailWork');
			$form.submit();
		}
